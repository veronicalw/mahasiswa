...
class FormScreenKajur extends Component {
      ...
      ReturnPushNotificationToLaboranDitolak = ()  => {
        let response = fetch('https://exp.host/--/api/v2/push/send',{
            ...
            body: JSON.stringify({
                ...
                title:'Peminjaman Laboratorium',
                body:'Peminjaman Laboratorium Ditolak Kajur karena '+ this.state.TextFieldAlasanTolak,
            })
        });
      }
    constructor(){
    ...
    Update(TextFieldid){
        fetch('http://192.168.43.181:8000/api/pinjams/'+TextFieldid, {
            ...
            body: JSON.stringify({
              ...
              app_kajur : this.state.TextFieldapp_kajur,
...
export default FormScreenKajur;
