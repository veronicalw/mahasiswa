...
class FormScreenKalab extends Component {
    ...
    static navigationOptions = {
     ...
     SendPushNotifications = ()  => {
        let response = fetch('https://exp.host/--/api/v2/push/send',{
            ...
            body: JSON.stringify({
                //Kirim Notif ke Kajur
                to:'ExponentPushToken[eHD_7XGJ5wDrvR7_CuRF2W]',
     ...
     ReturnPushNotificationToLaboran = ()  => {
        let response = fetch('https://exp.host/--/api/v2/push/send',{
            method: 'POST',
            headers: {
                Accept:'application/json',
            ...
            body: JSON.stringify({
                ...
                title:'Peminjaman Laboratorium',
                body:'Peminjaman Laboratorium Diterima Kalab'
            })
        });
      }
      ...
      ReturnPushNotificationToLaboranDitolak = ()  => {
        let response = fetch('https://exp.host/--/api/v2/push/send',{
            ...
            body: JSON.stringify({
                ...
                to:'ExponentPushToken[iOKij5DCO68TviDm2P2WMO]',
                title:'Peminjaman Laboratorium',
                body:'Peminjaman Laboratorium Ditolak Kalab karena ' + this.state.TextFieldAlasanTolak,
            })
        });
      }
    ...
    Update(TextFieldid){
        fetch('http://192.168.43.181:8000/api/pinjams/'+TextFieldid, {
            ...
            body: JSON.stringify({
              ...
              app_kalab : this.state.TextFieldapp_kalab,
                ...
                result.json().then((resp) => {
                    ...
                    if(this.state.TextFieldlevel == 1 && this.state.TextFieldapp_kalab == "Diterima"){
                        this.ReturnPushNotificationToLaboran();
                    ...
                    } else if(this.state.TextFieldlevel == 2 ||  this.state.TextFieldlevel == 3 && this.state.TextFieldapp_kalab == "Diterima" ){
...
export default FormScreenKalab;
