...
import ListKalab from '../../src/component/ListKalab';
class HomeScreenKalab extends Component {
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={{justifyContent:"center", paddingTop:10, paddingBottom:10}} >
                    <ScrollView>
                    <Text style={{alignContent:"center"}}>Aplikasi Kepala Laboran</Text>
                    {
                        this.state.pinjams.length > 0
                        ? <ListKalab pinjams={this.state.pinjams} />
...
export default HomeScreenKalab;
